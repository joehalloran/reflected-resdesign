...
<?php if ($dm_settings['show_postmeta'] != 0) : ?>
    ...
    <p class="text-right"><span class="glyphicon glyphicon-circle-arrow-right"></span> <?php _e('Posted In','devdmbootstrap3'); ?>: <?php the_category(', '); ?>
    <?php //echo get_the_term_list( $post->ID, 'lesson_plan_structure', 'Lesson Plan: ', ', ', '' ); ?></p> 
    <?php if( has_tag() ) : ?>
